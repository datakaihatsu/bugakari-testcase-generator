# -*- coding: utf-8 -*-
"""新規モードの各質問分類 vs 合格TC列 の診断。LevelVar/ExecKind/Flags/自動確定を併記。"""
...
def diag(folder, jsonname):
    ...
    print(f"{'種別':<5}{'inTC':<5}{'Sit':<5}{'Lv':<7}{'EK':<3}{'Flags':<12}{'#行':<4} 名称 / 判定")
    for sn in order:
        ...
        print(f"{kb:<5}{intc:<5}{sn:<5}{lv:<7}{str(ek):<3}{str(flags):<12}{len(rows):<4} {name} [{why}]{mark}")

diag("21_623816_管(函)渠型側溝", "32-353.20260401.20260401(20260401).json")
diag("22_605866_路上路盤再生工", "32-1332.20260401.20260401.json")
